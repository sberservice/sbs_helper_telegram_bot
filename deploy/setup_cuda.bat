...
echo update.bat теперь автоматически пытается сохранить CUDA-сборку torch на GPU-серверах.
echo setup_cuda.bat используйте для первичной настройки или ручного восстановления.
echo =========================================
pause
