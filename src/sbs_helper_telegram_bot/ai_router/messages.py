...
MESSAGE_AI_PROCESSING = "⏳ _Читаю ваш вопрос\\.\\.\\._"
...
MESSAGE_AI_REQUESTING_AUGMENTED_PAYLOAD = "⏳ _Собираю слова в предложения \\(до 20 секунд\\)\\._"
MESSAGE_AI_UPOS_NOT_FOUND_FALLBACK = "🔎 Код ошибки не найден в базе UPOS\\. Проверяю базу знаний\\."
...
_AI_MESSAGE_DEFAULTS: Dict[str, str] = {
    ...
    AI_MESSAGE_KEY_UPOS_NOT_FOUND_FALLBACK: MESSAGE_AI_UPOS_NOT_FOUND_FALLBACK,
