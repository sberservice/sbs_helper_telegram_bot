...
10. Если пользователь вводит длинный многострочный текст с адресом — это скорее всего заявка для валидации (если модуль доступен).
11. Для intent "ticket_validation" не дублируй весь исходный текст пользователя в `parameters.ticket_text`, если он очень длинный: передавай только информативный фрагмент.
