...
MESSAGE_SUBMENU = "🔢 *UPOS Ошибки*\n\n💡 _Введите код ошибки или выберите действие:_"
...
MESSAGE_ADMIN_SEARCH_ERROR_CODE = "🔍 *Поиск ошибки*\n\nВведите код ошибки для редактирования:"

MESSAGE_ADMIN_ERROR_NOT_FOUND_FOR_EDIT = "❌ *Ошибка не найдена*\n\nКод `{code}` отсутствует в базе данных\\. Используйте кнопку «➕ Добавить ошибку» для добавления\\."
