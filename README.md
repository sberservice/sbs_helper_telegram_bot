...
- **� UPOS Ошибки** — поиск кодов ошибок UPOS с описаниями и рекомендациями по устранению- **📝 Сертификация** — тестирование сотрудников с рейтингами и историей попыток- **�🔐 Инвайт-система** — регистрация только по приглашениям
...
| `/certification` | Начать сертификацию |
