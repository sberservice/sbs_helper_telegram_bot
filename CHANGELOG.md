...
### Changed
- Актуализирован `README.md` под текущее состояние проекта: добавлено описание AI-маршрутизатора (возможности, защита rate-limit/circuit breaker, контекст, логирование), расширены `.env`-настройки AI, добавлен SQL-шаг `scripts/ai_router_setup.sql`, обновлены структура проекта, меню и список зависимостей.
